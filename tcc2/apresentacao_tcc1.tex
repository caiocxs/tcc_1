...
\begin{frame}{Justificativa}
  ...
  \vspace{-0.85cm}\begin{figure}[h]
    ...
    \vspace{-0.25cm}\includegraphics[width=0.82\textwidth]{Images/Semgrep.png} \\
...
\begin{frame}{Justificativa}
    \begin{itemize}
      \item Lacuna de eficácia e escalabilidade na detecção de vulnerabilidades.
      \item Mitigar a dependência de engenharia manual.
      \item Contornar os altos custos da inferência direta por IAs.
    \end{itemize}
\end{frame}
...
\begin{frame}{Objetivo}
  \begin{block}{Objetivo Geral}
    \begin{itemize}
    \item Demonstrar um \textit{framework} de síntese automatizado de regras, baseado em LLMs, integrado à ferramenta SemGrep.
    \item Apresenta F1-Score e \textit{recall} superiores às abordagens tradicionais.
    \item Cinco \textit{Common Weakness Enumeration} (CWEs).
  \end{itemize}
\end{block}
\end{frame}
...
\begin{frame}{Objetivo}
  \begin{block}{Objetivos específicos}
    \begin{itemize}
      \item Determinar os limites de detecção semântica (\textit{corner-cases}) que podem ser superados pela abordagem gerativa de LLMs.
      \item Estabelecer o ganho quantitativo de desempenho (\textit{Recall}, Precisão e F1-Score) frente aos analisadores tradicionais.
      \item Determinar a viabilidade técnica e a escalabilidade de inferência da arquitetura proposta utilizando modelos de linguagem de menor escala (com contagem reduzida de parâmetros).
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{Metodologia da pesquisa bibliográfica}
  ...
  \vspace{-0.98cm}\begin{figure}[h]
    ...
    \vspace{-0.15cm}\includegraphics[width=0.53\textwidth]{Images/Funil.png} \\
      ...
      \item \textbf{SemGrep}:
        \begin{itemize}
          ...
          \item Curva de aprendizado é menor que CodeQL. \\ 
            {\footnotesize Gramática própria e banco relacional.}
...
\begin{frame}{LLM-based Vulnerability Detection...}
  ...
  \vspace{-0.88cm} \begin{figure}[h]
    ...
    \vspace{-0.15cm}\includegraphics[width=0.46\textwidth]{Images/LLM-Based-Analise.png} \\
...
\begin{frame}{Trabalhos relacionados}
  ...
  \vspace{-0.88cm} \begin{figure}[h]
    ...
    \vspace{-0.15cm}\includegraphics[width=0.54\textwidth]{Images/Table.png} \\
...
\setbeamerfont{caption}{size=\scriptsize}
  \vspace{-0.88cm} \begin{figure}[h]
    ...
    \vspace{-0.2cm}\includegraphics[width=0.65\textwidth]{Images/Cronograma.png} \\
    {\vspace{-0.25cm}\scriptsize Fonte: Elaborado pelo autor (2026)}
